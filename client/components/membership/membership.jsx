      ...
      { !member ? <div class="container mx-auto max-w-4xl">
        ...
        <div className="mt-8">
          <div className="flex justify-between">
            <div>
              <p className="text-sm text-gray-600"><span className="underline cursor-pointer text-blue-600"></span></p>
            </div>
            ...
            <div className="py-12">
              <div className="bg-white  pt-4 rounded-xl space-y-6 overflow-hidden transition-all duration-500 transform hover:-translate-y-6 -translate-y-2 scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
                <div className="px-8 flex justify-between items-center">
                  <h4 className="text-xl font-bold text-gray-800">{plan.duration === 12? `${plan.duration/12} Year` : `${plan.duration} Months`}</h4>
                ...
                <button onClick={()=>urlPay(plan.id)} className="inline-block my-6 font-bold text-white">Get started today</button>
                  </div>
              </div>
            </div>
          )
        ...
        <div class="absolute  inset-0 w-0 bg-white opacity-10 transition-all duration-[0.3s] ease-out group-hover:w-full"></div>
