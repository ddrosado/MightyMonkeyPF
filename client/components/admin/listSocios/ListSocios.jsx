          ...
          <div className="inline-block w-400 shadow rounded-lg overflow-hidden">
                            ...
                            <td className="px-5 py-5 bg-white text-sm">
                              {isActive ? (
                                <button
                                  ...
                                  className="text-sm bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-full"
                                >
                                  Ban
                                </button>
                              ) : (
                                <button
                                  ...
                                  className="text-sm bg-green-300 hover:bg-green-400 text-white font-semibold py-2 px-4 rounded-full"
                                >
                                  Enable
                                </button>
                              )}
            ...
            <div className="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between ">
              <span className="text-xs xs:text-sm text-gray-900">
                Page {page + 1} the {Math.ceil(user.length / 5)} of{" "}
                {user.length} Users
              </span>
